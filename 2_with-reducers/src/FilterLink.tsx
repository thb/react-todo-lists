...
export function FilterLink({ filter, currentFilter, onFilterChange, children }: FilterLinkProps) {
  if (filter === currentFilter) {
    // If the filter is active, just display it as plain text (non-clickable)
